...
## 6. Chat Listing
The `chats` property, for now, is undefined and is supposed to be a [deepstream list](https://deepstream.io//tutorials/core/datasync/lists/) which will hold the collection of deepstream records. 
